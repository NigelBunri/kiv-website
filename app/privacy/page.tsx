      ...
      <Section title="Privacy policy provisions" body="Drafted terms, pending legal review.">
        <DetailList
          items={[
            ...
            { title: "Data retention", body: "Form submissions and account data are kept only as long as needed for the purpose collected, or as required by law, then deleted or anonymised. Where in-product messaging is used, a deleted message's content is scrubbed from storage after a defined retention period rather than kept indefinitely." },
